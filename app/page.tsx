...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6 bg-[#0f0f1a]">
      <div className="max-w-md w-full text-center space-y-12">
        <div className="relative transform -rotate-2">
          ...
          <div className="bg-indigo-900 border-4 border-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            <h1 className="text-4xl md:text-5xl font-black tracking-tighter uppercase text-white drop-shadow-[2px_2px_0px_rgba(0,0,0,1)]">
              MagicStory
            </h1>
